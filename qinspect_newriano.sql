...
-- Tiempo de generación: 23-02-2026 a las 10:03:42
...
--
-- Base de datos: `qinspect_newriano`
--
...
--
-- Disparadores `adjuntosInspeccion`
--
DELIMITER $$
CREATE TRIGGER `actuAdjInspOld` BEFORE INSERT ON `adjuntosInspeccion` FOR EACH ROW INSERT INTO `Adjuntos_inspec`(`id_Adjunto`, `foto`, `observaciones`, `Rdp_Id`) VALUES (new.`idAdjunto`, new.`urlAdjunto`, new.`obsAdjunto`, new.`idRtaInspeccion`)
$$
DELIMITER ;
...
--
-- Estructura de tabla para la tabla `Adjuntos_inspec`
--

CREATE TABLE `Adjuntos_inspec` (
  `id_Adjunto` int(20) NOT NULL,
  `foto` mediumtext CHARACTER SET utf8 COLLATE utf8_spanish_ci,
  `observaciones` varchar(10000) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `Rdp_Id` int(20) NOT NULL
...
CREATE TABLE `apilog` (
  ...
  `funcionApiName` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sqlRequest` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `fecha` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `checkIn` tinyint(1) DEFAULT '0',
  `checkOut` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `fallas_solucionadas` (
  ...
  `Observaciones` varchar(2000) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `Persona_Documento` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Disparadores `fallas_solucionadas`
--
DELIMITER $$
CREATE TRIGGER `InsertFallasNew` BEFORE INSERT ON `fallas_solucionadas` FOR EACH ROW INSERT INTO `fallasSolucionadas`(`idFallasSolcionadas`, `rdpId`, `idResumenPreoperacional`, `idItemMalo`, `fechaReporteFalla`, `fechaReporteSolucion`, `foto`, `observaciones`, `personaDocumento`,  `usuarioControl`) VALUES (New.`idFallasSolcionadas`, New.`Rdp_Id`, New.`idresumenpreoperacional`, New.`idItemMalo`, New.`fechaReporteFalla`, New.`fechaReporteSolucion`, New.`Foto`, New.`Observaciones`, New.`Persona_Documento`,New.`Persona_Documento`)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_fallas_resueltas` BEFORE INSERT ON `fallas_solucionadas` FOR EACH ROW UPDATE `Rta_Doc_Preop` SET `Rdp_TieneOestado`='B' WHERE `Rdp_Id`=New.`Rdp_Id`
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_fallas_resueltasnEW` BEFORE INSERT ON `fallas_solucionadas` FOR EACH ROW UPDATE `rtaPreoperacional` SET `idPreoperacional`='B' WHERE `idRtaPreop`=New.`Rdp_Id`
$$
DELIMITER ;
...
CREATE TABLE `notify_correo` (
  ...
  `tiponotificacion` varchar(50) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `notify_correo2` (
  ...
  `estado` int(11) NOT NULL DEFAULT '1',
  `tiponotificacion` varchar(50) CHARACTER SET latin1 NOT NULL COMMENT 'DCV= doc conduc, DVV= DOC VEHI Y TRAILER, PAN= PREOPE APRO NO ABRO'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `resumenPreoperacional` (
  ...
  `positionGps` text COLLATE utf8mb4_unicode_ci NOT NULL
...
--
DELIMITER $$
CREATE TRIGGER `actuResumenOld` BEFORE INSERT ON `resumenPreoperacional` FOR EACH ROW INSERT INTO `Resumen_Preoperacional`(`ResuPre_Id`, `ResuPre_Fecha`, `ResuPre_UbicExpPre`, `ResuPre_Kilometraje`, `tanque_galones`, `ResuPre_Fotokm`, `Pers_NumeroDoc`, `ResuPre_guia`, `ResuPre_Fotoguia`, `Veh_Id`, `Remol_Id`, `Ciu_Id`,`fotoCabezote`,`fotoTrailer`) VALUES (new.`idResumen`, new.`fechaPreoperacional`, new.`ciudadGps`, new.`kilometraje`, new.`cantTanqueoGalones`, new.`urlFotoKm`, new.`usuarioPreoperacional`, new.`numeroGuia`, new.`urlFotoGuia`, (SELECT Veh_Id FROM `Vehiculo` WHERE Veh_Placa=new.`placaVehiculo`), (SELECT Remol_Id FROM `Remolque` WHERE Remol_Placa=new.`placaRemolque`), new.`idCiudad`,new.`fotoCabezote`,new.`fotoTrailer`)
$$
DELIMITER ;
...
--
-- Estructura de tabla para la tabla `Resumen_Preoperacional`
--

CREATE TABLE `Resumen_Preoperacional` (
  `ResuPre_Id` int(11) NOT NULL,
  `ResuPre_Fecha` datetime NOT NULL,
  `ResuPre_UbicExpPre` varchar(200) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL COMMENT 'ubicación de expedicion del preoperacional',
  `ResuPre_Kilometraje` int(20) NOT NULL,
  `tanque_galones` int(11) DEFAULT NULL,
  `ResuPre_Fotokm` mediumtext CHARACTER SET utf8 COLLATE utf8_spanish_ci,
  `Pers_NumeroDoc` int(20) NOT NULL,
  `ResuPre_guia` varchar(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `ResuPre_Fotoguia` mediumtext CHARACTER SET utf8 COLLATE utf8_spanish_ci,
  `Veh_Id` int(20) NOT NULL,
  `Remol_Id` int(20) DEFAULT NULL,
  `Ciu_Id` int(20) NOT NULL,
  `fotoCabezote` longtext,
  `fotoTrailer` longtext
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='parte ppl del preoperacional';

--
-- Disparadores `Resumen_Preoperacional`
--
DELIMITER $$
CREATE TRIGGER `sumar_inspeccion` BEFORE INSERT ON `Resumen_Preoperacional` FOR EACH ROW UPDATE `Notificaciones` INNER JOIN Usuario on Usuario.UsuarioUser=Notificaciones.idusuario  SET `newinspeccion`=newinspeccion+1  WHERE Usuario.Rol_Id!=2
$$
DELIMITER ;
...
--
-- Disparadores `rtaPreoperacional`
--
DELIMITER $$
CREATE TRIGGER `actuRtaPrepeOld` BEFORE INSERT ON `rtaPreoperacional` FOR EACH ROW INSERT INTO `Rta_Doc_Preop`(`Rdp_Id`, `Rdp_TieneOestado`, `ResuPre_Id`, `IInsp_Id`, `fecha_vencimiento`) VALUES (new.`idRtaPreop`, new.`rtaUsuario`, new.`idPreoperacional`, new.`idItemInps`, new.`fechaVencimiento`)
$$
DELIMITER ;
...
--
-- Estructura de tabla para la tabla `Rta_Doc_Preop`
--

CREATE TABLE `Rta_Doc_Preop` (
  `Rdp_Id` int(20) NOT NULL,
  `Rdp_TieneOestado` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ResuPre_Id` int(11) NOT NULL,
  `IInsp_Id` int(20) NOT NULL,
  `fecha_vencimiento` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='respuestas del preoperacional en general';
...
CREATE TABLE `Vehiculo` (
  ...
  `Prov_Id` int(20) NOT NULL,
  `Tv_Id` int(20) NOT NULL,
  `id_integracion` int(20) NOT NULL COMMENT 'aca va el id del cliente al cual esta integrando el vehiculo, si no lleva siempre va 0'
...
CREATE TABLE `versionFormatos` (
  ...
  `pertenece` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'a que tipo de formato pertenece, para asi mismo mostrar en los pdf',
...
CREATE TABLE `version_formatos` (
  ...
  `Nombre_formato` varchar(250) CHARACTER SET latin1 NOT NULL,
  `version` varchar(5) CHARACTER SET latin1 NOT NULL,
  `codigo` varchar(50) CHARACTER SET latin1 NOT NULL,
  `pertenece` varchar(250) CHARACTER SET latin1 NOT NULL,
...
--
-- Indices de la tabla `Adjuntos_inspec`
--
ALTER TABLE `Adjuntos_inspec`
  ADD PRIMARY KEY (`id_Adjunto`),
  ADD KEY `Rdp_Id` (`Rdp_Id`);
...
ALTER TABLE `evidencias`
  ADD PRIMARY KEY (`id_Evidencia`,`id_Capacitacion1`),
  ADD KEY `fk_evidencias_capacitacion1_idx` (`id_Capacitacion1`);
...
--
-- Indices de la tabla `Resumen_Preoperacional`
--
ALTER TABLE `Resumen_Preoperacional`
  ADD PRIMARY KEY (`ResuPre_Id`),
  ADD KEY `Pers_Id` (`Pers_NumeroDoc`),
  ADD KEY `Veh_Id` (`Veh_Id`),
  ADD KEY `Ciu_Id` (`Ciu_Id`),
  ADD KEY `Remol_Id_2` (`Remol_Id`);
...
--
-- Indices de la tabla `Rta_Doc_Preop`
--
ALTER TABLE `Rta_Doc_Preop`
  ADD PRIMARY KEY (`Rdp_Id`),
  ADD KEY `ResuPre_Id` (`ResuPre_Id`),
  ADD KEY `IInsp_Id` (`IInsp_Id`);
...
--
-- AUTO_INCREMENT de la tabla `Adjuntos_inspec`
--
ALTER TABLE `Adjuntos_inspec`
  MODIFY `id_Adjunto` int(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `evidencias`
  MODIFY `id_Evidencia` int(25) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `Resumen_Preoperacional`
--
ALTER TABLE `Resumen_Preoperacional`
  MODIFY `ResuPre_Id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `Rta_Doc_Preop`
--
ALTER TABLE `Rta_Doc_Preop`
  MODIFY `Rdp_Id` int(20) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `Adjuntos_inspec`
--
ALTER TABLE `Adjuntos_inspec`
  ADD CONSTRAINT `Adjuntos_inspec_ibfk_1` FOREIGN KEY (`Rdp_Id`) REFERENCES `Rta_Doc_Preop` (`Rdp_Id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `evidencias`
  ADD CONSTRAINT `fk_evidencias_capacitacion1` FOREIGN KEY (`id_Capacitacion1`) REFERENCES `capacitacion_v2` (`id_Capacitacion`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `Resumen_Preoperacional`
--
ALTER TABLE `Resumen_Preoperacional`
  ADD CONSTRAINT `Resumen_Preoperacional_ibfk_1` FOREIGN KEY (`Ciu_Id`) REFERENCES `Ciudad` (`Ciu_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Resumen_Preoperacional_ibfk_3` FOREIGN KEY (`Pers_NumeroDoc`) REFERENCES `Personal` (`Pers_NumeroDoc`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Resumen_Preoperacional_ibfk_4` FOREIGN KEY (`Veh_Id`) REFERENCES `Vehiculo` (`Veh_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Resumen_Preoperacional_ibfk_5` FOREIGN KEY (`Remol_Id`) REFERENCES `Remolque` (`Remol_Id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Rta_Doc_Preop`
--
ALTER TABLE `Rta_Doc_Preop`
  ADD CONSTRAINT `Rta_Doc_Preop_ibfk_1` FOREIGN KEY (`IInsp_Id`) REFERENCES `Item_Inspeccion` (`IInsp_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Rta_Doc_Preop_ibfk_2` FOREIGN KEY (`ResuPre_Id`) REFERENCES `Resumen_Preoperacional` (`ResuPre_Id`) ON DELETE CASCADE ON UPDATE CASCADE;
