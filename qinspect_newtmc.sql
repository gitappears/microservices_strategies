...
-- Tiempo de generación: 23-02-2026 a las 10:03:17
...
CREATE TABLE `version_formatos` (
  ...
  `Nombre_formato` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `version` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `codigo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pertenece` enum('Preoperacional','Capacitaciones','Encuestas','Especial') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'a que tipo de formato pertenece, para asi mismo mostrar en los pdf',
  `id_empresa` int(20) NOT NULL,
  `paginacion` enum('NO','SI') NOT NULL DEFAULT 'NO',
  `fPredefinida` enum('NO','SI') NOT NULL DEFAULT 'NO',
  `usuarioFirma` varchar(50) DEFAULT NULL,
  `visible` enum('NO','SI') NOT NULL DEFAULT 'SI',
  `iniciaAdmin` enum('NO','SI') DEFAULT 'SI',
...
ALTER TABLE `Empresa`
  ...
  ADD KEY `id_emp_panes` (`Id_emp_plan`) USING BTREE;
...
ALTER TABLE `itemInspeccion`
  ...
  ADD KEY `idx_item_join_filter` (`idItemInsp`,`estadoItem`,`idCatItem`);
...
ALTER TABLE `llaveItemTpv`
  ...
  ADD KEY `usuarioControl` (`usuarioControl`),
  ADD KEY `idx_llave_joins` (`idTpVehiculo`,`idItem`);
...
ALTER TABLE `resumenPreoperacional`
  ...
  ADD KEY `fechaPreoperacional` (`fechaPreoperacional`),
  ADD KEY `idrol` (`idrol`),
  ADD KEY `tipoPreope` (`tipoPreope`),
  ADD KEY `ciudadGps` (`ciudadGps`);
...
ALTER TABLE `rtaPreoperacional`
  ...
  ADD KEY `idx_fallas_optimo` (`rtaUsuario`,`idPreoperacional`,`idItemInps`),
  ADD KEY `rtaUsuario` (`rtaUsuario`);
...
ALTER TABLE `vehiculo`
  ...
  ADD KEY `idx_vehiculo_join_filter` (`idTipoVeh`,`estadoVeh`,`placa`);
...
--
ALTER TABLE `Respuestasencuestasok`
  ADD CONSTRAINT `Respuestasencuestasok_ibfk_1` FOREIGN KEY (`RespuestaSeleccionada`) REFERENCES `Enc_Respuestas` (`Id_resp`) ON DELETE CASCADE ON UPDATE CASCADE;
